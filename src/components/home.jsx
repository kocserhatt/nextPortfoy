    ...
    return (
        <div id="anasayfa" className="home">
            <div className="left">
                ...
                <p className="home-paragraph">Bu da benim portföy projem&rsquo;. Benim hakkımda bilgi edinmek istersen&apos;, Hakkımda kısmını okuyabilir ya da CV mi indirerek özgeçmişim hakkında bilgi sahibi olabilirsin&rsquo;.</p>
                <div className="btns">
